...
public class JWTUtils {
    ...
    // High performance in-memory blacklist to replace Redis
    ...
    public void revokeToken(String token) throws Exception {
        ...
        if (ttl > 0) {
            ...
            log.info("Blacklisted token in-memory: {}", token);
        }
        
        // Periodic cleanup when blacklist grows to prevent memory leaks
