...
<template>
  <!--
    CVForm: natural height, no internal overflow-y-auto.
    The PARENT panel manages scrolling. This keeps transform-free layout intact.
  -->
  <div class="p-6" v-if="store.currentCV?.content && store.currentCV.content.profile">
    ...
    <div v-if="activeTab === 'projects'" class="space-y-6">
        ...
        <div v-else class="text-gray-500 italic">No projects yet. Click + Add to begin.</div>
    </div>
  ...
  <!-- Empty state -->
  <div v-else class="p-6 text-gray-400 italic text-sm">Loading form data...</div>
</template>
